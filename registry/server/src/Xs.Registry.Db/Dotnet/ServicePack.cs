...
public class ServicePack : ServicePackBase
{
    ...
    public override void Register(IServiceContainer container, IServiceProvider provider)
    {
        ...
        // repositories
        container.Add<Func<Context, ITable<Entities.Package>>>(context => context.DotnetPackages).AsSelf().Singleton();
        container.Add<Func<Context, ITable<Entities.PackageDependency>>>(context => context.DotnetPackageDependencies).AsSelf().Singleton();
