        ...
        ILogSubject
{
    ...
    {
        var data = new CommandDescription { Entity = Annium.Extensions.CommandLine.Cli.Prompt("Entities: ") };
        ct.ThrowIfCancellationRequested();
        data.Name = Annium.Extensions.CommandLine.Cli.Prompt("Command name: ");
        ct.ThrowIfCancellationRequested();
